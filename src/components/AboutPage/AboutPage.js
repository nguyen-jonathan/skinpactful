    ...
    <div className="app">
      ...
      <div className="aboutPage-section-container">
        ...
        <div className="aboutPage-content-container">
          <div className="aboutPage-content1">
            <div className="aboutPage-section-text-container1">
              <p className="aboutPage-primary-text">
                ...
                name is Thomas (32 years old) and I have been battling with
                adult acne for nearly 10 years. I would be insecure about going
                out in public and constantly looking in a mirror throughout the
                day, hoping it would magically get better. After a while I got
                tired of this insecurity of mine and decided to dedicate myself
                to curing this disorder.
              </p>
              <p className="aboutPage-primary-text">
                I have researched and tested dozens of products, spoke with
                skincare professionals, altered my diet, literally everything
                you can think of. SPOILER ALERT, I ended up cracking the code to
                winning this war against this annoying splinter in my life. Now
                my friends, family and even strangers would approach me
          ...
          <div className="aboutPage-content2">
            ...
            <div className="aboutPage-section-text-container4">
              <p className="aboutPage-primary-text">
                ...
                skin care products that aren't helping you. Everyone is
                different and I believe listening to each other's story and
                having a real 1-on-1 discussion is the best way to discover what
                your skin needs.
              </p>
            </div>
          </div>
