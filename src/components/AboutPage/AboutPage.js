      ...
      <div className="aboutPage-section-container">
        ...
        <div className="aboutPage-section-text-container">
          <p className="aboutPage-primary-text">
            ...
            is Thomas (32 years old) and I have been battling with adult acne
            for nearly 10 years. I would be insecure about going out in public
            and constantly looking in a mirror throughout the day, hoping it
            would magically get better. After a while I got tired of this
            insecurity of mine and decided to dedicate myself to curing this
            disorder.{' '}
          </p>
          <p className="aboutPage-primary-text">
            ...
            to winning this war against this annoying splinter in our lives! Now
            my friends, family and strangers would approach me complimenting me
            on my skin, which I couldn’t believe!
          </p>
          <p className="aboutPage-primary-text">
